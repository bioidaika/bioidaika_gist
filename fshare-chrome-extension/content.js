(function() {
    ...
    async function fetchFolderData() {
        ...
        console.log('[Fshare API Extension] Đang lấy dữ liệu cho thư mục:', linkcode);
        ...
        try {
            ...
            console.log('[Fshare API Extension] Đã lấy thành công tổng cộng:', allItems.length, 'mục');
            ...
            console.error('[Fshare API Extension] Lỗi:', error);
    ...
    function showTableModal(originalItems) {
        ...
        let selectedLinkcodes = new Set(items.map(i => i.linkcode));
        ...
        const doCopy = (text, btnElement, successText) => {
            // Chrome Extension context: sử dụng navigator.clipboard
            navigator.clipboard.writeText(text).then(() => {
                ...
                alert("Không thể copy. Vui lòng cấp quyền Clipboard cho trang web.");
            });
        };
